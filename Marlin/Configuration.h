...
#define STRING_CONFIG_H_AUTHOR "(H3D_GeniusHEM_BL_5V_2.0.9.3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Artillery Genius BLTOUCH 5V HEMERA - Patreon Edition"
